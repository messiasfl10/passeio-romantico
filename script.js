...
const locais = [
  ...
  },
  {
    ...
    texto: "Lugar de vários pores do sol, passeios, declarações, noites de luar, além do nosso pedido de namoro e muito amor 💕. Conforme o tempo foi passando, meu amor por você só foi crescendo. Você me tornou uma pessoa melhor. Hoje, não me vejo mais sem você, sem sua companhia, suas risadas, suas trapalhadas, seus conselhos, seu sorriso, seu olhar, seu toque, seu abraço, seu beijo ... simplesmente você, pois meu futuro é contigo."
  },
  {
    id: "local4",
    nome: "Moranga Bistrô",
  ...
  locais.forEach(local => {
    ...
    if(distancia <= avisoProximo && !secao){
      if(!document.getElementById(`${local.id}-aviso`)){
        ...
        aviso.innerText = `💫 O próximo local está perto!`;
